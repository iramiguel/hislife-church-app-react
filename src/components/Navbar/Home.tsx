      ...
      <div className="content-section">
        ...
        <div className="second-message-panel">
          <div className="container">
            ...
            <p>
              You didn’t just find this page. You were led here — by grace, for
              a reason.<br></br>
            ...
            <div className="dual-column">
              ...
              <div className="column">
                ...
                <p>
                  Your life has meaning because God created you with intention.
                  You’re not here by chance. God designed you with gifts,
                  dreams, and a purpose that only you can fulfill. Discovering
                  Him is the first step to discovering why you’re here.
                </p>
              </div>
              <div className="column">
                <h2>You Are Not Alone</h2>
                <p>
                  God walks with you through every season — even when it’s hard
                  to see. In pain, joy, confusion, or fear, He never leaves. You
                  don’t have to carry life’s weight by yourself. His presence is
              ...
              <div className="column">
                ...
                <p>
                  ...
                  came not to judge, but to restore. No sin, failure, or past is
                  too big for His mercy. With Him, every day is a chance to
                  begin again.
                </p>
              </div>
              <div className="column">
                ...
                <p>
                  ...
                  connection. He’s not asking for perfection. He’s inviting you
                  to know Him personally, to walk with Him daily, and to grow in
                  faith, step by step.
                </p>
              </div>
            </div>
